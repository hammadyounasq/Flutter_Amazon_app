...
import 'package:amazon_clone_flutter/feature/search/screen/searched_product.dart';
import 'package:amazon_clone_flutter/feature/search/service/search_service.dart';
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  fetchSearchedProduct() async {
    products = await searchServices.fetchShearchProducts(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return GestureDetector(
                          ...
                          child: SearchedProduch(Products: products![index]));
                    },
                  ),
                ),
              ],
